...
export default function useMonetizationStatesPreview() {
    ...
    const handleExportMonetization = async () => {
        ...
        try {
            ...
            // For monetization export, we'll use the project ID as the history document ID
            // since monetizations are stored per project
            await createMonetizationHistoryRecord(
                'MONETIZATION_EXPORT',
                currentProject.id, // Use project ID as history document ID
